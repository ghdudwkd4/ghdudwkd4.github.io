...
<p>
    Cron : 일반적으로 스케줄 서비스의 이름이며,<br >
           ...
           관리자가 원하는 시간, 날짜에 주기적으로 실행할 수 있도록 해줍니다.<br >
</p>
<p>
    Crontab : crontab은 작업 목록 및 cron 데몬에 대한 명령어들이 보관된 위치에 저장되어 있습니다.
</p>
<br >
...
### ※ 주의사항
명령어 작성법과, cronTab 설정파일 위치에 있는 설정 폴더가 따로 있습니다. <br/>
두가지 방법을 적절히 사용하되 명령어에 없다고 스케줄러가 없는건 아닙니다. <br/>
...
1. crontab 명령어로 작업
    ...
    4. 자세한 옵션을 확인하려면 info crontab 으로 확인바랍니다.<br ><br >
        ...
        아래와 같이 해당하는 시간에 맞춰 작성합니다.<br ><br >
...
2. crontab 설정파일에서 작업
    1. 위치             : /etc 하위에 위치해있습니다.
    2. /etc/cron.d      : 소프트웨어 패키지를 설치할 때 필요한 주기적 작업을 등록하는 공간으로 사용.
    3. /etc/crontab     : 관리자가 직접 지정한 작업을 설정하며 , 임의의 사용자 권한으로 실행할 수 있습니다.<br>
                          시스템 관련 작업을 등록하는 곳입니다.
